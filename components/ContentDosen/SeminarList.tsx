       ...
       >
        ...
        {data.fileSeminar ?
         <td className="px-6 py-2 text-right flex gap-2">
          <button
           onClick={() => getValue(data.uid, data.profOne, data.profTwo, data.seminarDate[0].feedbackNote, data.seminarDate[0].isApprovedByProfOne, data.seminarDate[0].isApprovedByProfTwo, data.seminarDate[0].dateToBe)}
