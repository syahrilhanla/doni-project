        ...
        >
         ...
         {data.fileSeminar ?
          <td className="px-6 py-2 text-right flex gap-2">
           <button
            onClick={() => getValueApprove(data.uid, data.name, data.profOne, data.profTwo, data.seminarDate[0].feedbackNoteByProfOne, data.seminarDate[0].feedbackNoteByProfTwo, data.seminarDate[0].isApprovedByProfOne, data.seminarDate[0].isApprovedByProfTwo, data.seminarDate[0].dateToBe)}
           ...
           <button
            onClick={() => getValueDenied(data.uid, data.name, data.profOne, data.profTwo, data.seminarDate[0].feedbackNoteByProfOne, data.seminarDate[0].feedbackNoteByProfTwo, data.seminarDate[0].isApprovedByProfOne, data.seminarDate[0].isApprovedByProfTwo, data.seminarDate[0].dateToBe)}
