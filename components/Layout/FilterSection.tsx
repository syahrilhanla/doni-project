  ...
  return (
    <div className={`flex justify-center items-center my-5 py-4 w-5/6  xxs:max-sm:flex-col sm:max-md:flex-col md:max-lg:flex-col `}>
        <div className="realtive xxs:max-sm:w-full sm:max-md:w-full md:max-lg:w-full">       
              <button
            className="bg-[#f1e8f252] focus:outline-none  justify-between xxs:max-sm:w-full sm:max-md:w-full md:max-lg:w-full  text-[#707070] w-44  hover:bg-[#ebe6ea]  font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center"
