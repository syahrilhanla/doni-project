...
const FilterSection = () => {
  ...
  return (
    <div className={`flex justify-center items-center my-5 py-4 w-5/6 `}>
        <div className="realtive">       
              <button
            className="bg-[#f1e8f252] justify-between  text-[#707070] w-44  hover:bg-[#ebe6ea]  font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center"
          ...
          <div
            id="dropdown"
            className={`z-10 w-20 bg-white rounded divide-y divide-gray-100 shadow ${isOpen ? "inline " : "hidden"
              }`}
          >
            <ul className=" z-1 w-44 bg-white rounded divide-y divide-gray-100 shadow ">
              <li
              >
